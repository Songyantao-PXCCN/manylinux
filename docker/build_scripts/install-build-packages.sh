...
#	COMPILE_DEPS="libz-dev libbz2-dev libexpat1-dev libncurses5-dev libreadline-dev tk-dev libgdbm-dev libdb-dev libpcap-dev liblzma-dev openssl libssl-dev libkeyutils-dev libkrb5-dev comerr-dev libidn2-0-dev libcurl4-openssl-dev uuid-dev libffi-dev linux-kernel-headers"
	COMPILE_DEPS="libz-dev libbz2-dev libexpat1-dev libncurses5-dev libreadline-dev tk-dev libgdbm-dev libdb-dev libpcap-dev liblzma-dev openssl libssl-dev libkeyutils-dev libidn2-0-dev libcurl4-openssl-dev uuid-dev libffi-dev linux-kernel-headers"

#  'openssl libssl-dev'  preinstall for git
#  libkrb5-dev krb5-multidev comerr-dev   seems can not install together using Aliyun
...
if [ "${PACKAGE_MANAGER}" == "yum" ]; then
	...
	apt-get update -qq
	apt-get install  -y --no-install-recommends ${COMPILE_DEPS}
